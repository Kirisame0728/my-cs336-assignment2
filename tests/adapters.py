...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    from cs336_systems.pytorch_flash_attn_2 import FlashAttentionTorch
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    from cs336_systems.triton_flash_attn_2 import FlashAttentionTriton
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    from cs336_systems.ddp_overlap_bucketed import DDPBucket
    ddp_bucket = DDPBucket(module, bucket_size_mb)
    return ddp_bucket
...
def get_sharded_optimizer(params, optimizer_cls: Type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    from cs336_systems.optimizer_state_sharding import DDPOpSharing
    return DDPOpSharing(params, optimizer_cls, **kwargs)
